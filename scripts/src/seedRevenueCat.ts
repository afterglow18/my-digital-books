...
const PROJECT_NAME        = "My Digital Books";
const APP_STORE_APP_NAME  = "My Digital Books";
const APP_STORE_BUNDLE_ID = "com.mydigitalbooks.app";
...
const PRODUCTS: ProductDef[] = [
  {
    identifier:  "digital_books_monthly",
    displayName: "Monthly – My Digital Books",
    type:        "subscription",
    duration:    "P1M",
  ...
  {
    identifier:  "digital_books_yearly",
    displayName: "Yearly – My Digital Books",
    type:        "subscription",
    duration:    "P1Y",
  ...
  {
    identifier:  "digital_books_lifetime",
    displayName: "Lifetime – My Digital Books",
    type:        "non_consumable",
