...
const BG_CENTER   = "rgba(80,45,15,0.48)";   // deep brown semi-transparent card
        ...
        >
          {items.slice(lo, hi + 1).map((item, localIdx) => {
            ...
            if (transitioning) {
              ...
              bg      = `rgba(80,45,15,${(p * 0.48).toFixed(3)})`;
              shadow  = p > 0.05
                ? `0 ${(4 * p).toFixed(1)}px ${(16 * p).toFixed(1)}px rgba(100,130,200,${(0.22 * p).toFixed(3)})`
                : "none";
            }
