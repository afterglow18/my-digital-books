# App Store Submission Guide — My Digital Books
...
3. Fill in:
   - Platform: iOS
   - Name: **My Digital Books**
   - Primary Language: English (U.S.)
   - Bundle ID: **com.mydigitalbooks.app** *(you'll need to register this in your Developer account first)*
...
3. Bundle ID: `com.mydigitalbooks.app`
...
- [ ] In-App Purchase created in App Store Connect (Product ID: `com.mydigitalbooks.app.premium`)
...
→ Register `com.mydigitalbooks.app` in your Apple Developer account (Step 3)
